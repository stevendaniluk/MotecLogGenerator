...
DESCRIPTION = """Generates MoTeC .ld files from external log files generated by: CAN bus dumps, or
COBB Accessport CSV files"""
...
moted channel will be created for every channel logged, the name and units will be directly copied
over.
"""
